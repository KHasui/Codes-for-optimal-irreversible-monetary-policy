...
disp('Main file: model with the policy irreversibility.')
disp(' NOTE: This code takes at least 20 hours to complete. If you stop the process, please push Keys "Ctrl + c."')
...
eval(['save result_irrev_indlamdaf',num2str(indlamdaf),'_zlb_sig',num2str(round(sig*100)),'_kpp',num2str(round(kpp*1000))])
save resultxx
