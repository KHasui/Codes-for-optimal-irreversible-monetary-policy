...
% IRFs under commitment and interest-rate-smoothing are available upon request (khasui@g.matsuyama-u.ac.jp).
...
eval(['load result_irrev_indlamdaf',num2str(indlamdaf),'_zlb_sig100_kpp24'])
