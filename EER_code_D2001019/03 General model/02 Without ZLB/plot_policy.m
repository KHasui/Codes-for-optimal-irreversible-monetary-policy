...
eval(['load result_irrev_indlamdaf',num2str(lind),'_nozlb_sig100_kpp24 gmat ilagmat dltlagmat imat pmat ymat'])
...
%(a) lambda_ir = 10      
subplot(2,2,1)
h=plot(gridg,4*p_intp_pd,gridg,4*p10_intpneg,gridg,4*p10_intp1,gridg,4*p10_intp0,[4*rss 4*rss],[-100 100]);
    h_axes = gca;
...
%(a) lambda_ir = 0.0016
subplot(2,2,2)
h=plot(gridg,4*p_intp_pd,gridg,4*p016_intpneg,gridg,4*p016_intp1,gridg,4*p016_intp0,[4*rss 4*rss],[-100 100]);
    h_axes = gca;
    h_axes.XAxis.FontSize = gridfontsize;
    h_axes.XAxis.FontName = 'Times';
    h_axes.YAxis.FontSize = gridfontsize;
